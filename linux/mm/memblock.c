				...
				int nid)
{
	...
	printk("slab unavailable; using bootmem\n");
	...
	if (max_addr > memblock.current_limit)
		...
		printk("trying to allocate in range %x to %x\n", min_addr, max_addr);
again:
	...
	printk("allocation failed, returning NULL\n");
	return NULL;
done:
...
void __init_memblock memblock_trim_memory(phys_addr_t align)
{
	...
	for_each_memblock(memory, r) {
		...
		printk("memblock_trim_memory: start %x, end %x, orig_start %x, orig_end %x\n", start, end, orig_start, orig_end);
